...
const UPDATE_CYCLE_STATUS = 'UPDATE users SET status=$1::varchar WHERE "facebookID"=$2';
const GET_STATUS_QUERY = 'SELECT status FROM users WHERE "facebookID"=$1';
const UPDATE_NICKNAME_QUERY = 'UPDATE users SET nickname=$1::varchar WHERE "facebookID"=$2';
